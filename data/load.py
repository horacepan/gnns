...
def load_qm9(frac=None, seed=42, small=False):
    ...
    if small:
        ...
        pickle_name = '/stage/risigroup/NIPS-2017/Experiments-%s/data/%s_1000.pickle' %(dataset, dataset.lower())
    ...
    test_split_file = '/stage/risigroup/NIPS-2017/Experiments-%s/splits/test_%d.txt' %split
